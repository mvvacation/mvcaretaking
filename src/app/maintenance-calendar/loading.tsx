export default function MaintenanceCalendarLoading() {
  return (
    <>
      <section className="bg-navy-950 text-white section-padding relative overflow-hidden">
        <div className="container-narrow text-center">
          <div className="h-4 w-40 bg-navy-800 rounded mx-auto mb-4 animate-pulse" />
          ...
          <div className="grid sm:grid-cols-2 gap-8">
            {Array.from({ length: 4 }).map((_, i) => (
              <div key={i} className="rounded-2xl border border-navy-100/50 p-8">
                <div className="w-10 h-10 bg-navy-100 rounded-lg animate-pulse mb-4" />
